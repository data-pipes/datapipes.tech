  ...
  return (
    <AboutWrapper id="about">
      ...
      <AboutInfo>
        ...
        <p>
          Hi, I'm Ivan Atanasov passionate self-taught frontEnd web developer from India. I tend to make use of modern web technologies to build websites that looks great, feels fantastic, and functions correctly. Focusing especially on Reactjs.
          <br />
          <br />
